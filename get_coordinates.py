...
class World(object):
    ...
    def restart(self):
        ...
        if self.player is not None:
            ...
            self.destroy()
            spawn_point = self.map.get_waypoint(carla.Location(x=-86.347275, y=24.404694, z=-0.002745))
            spawn_point.location.x = -86.347275
            spawn_point.location.y = 24.404694
            spawn_point.location.z = -0.002745
    ...
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        if not self._parent.type_id.startswith("walker.pedestrian"):
            self._camera_transforms = [
                ...
                (carla.Transform(carla.Location(x=-0.07*bound_x, y=-0.25*bound_y, z=1.025*bound_z)), Attachment.Rigid),
            ...
            self._camera_transforms = [
                ...
                (carla.Transform(carla.Location(x=-1.0, y=0.5, z=1.7)), Attachment.Rigid),
